<footer class="landing-footer">
    <div class="footer-top position-relative overflow-hidden">
      <img
        src="aplikasi/material/assets/img/front-pages/backgrounds/footer-bg.png"
        alt="footer bg"
        ...
        <div class="row gx-0 gy-7 gx-sm-6 gx-lg-12">
          ...
          <div class="col-lg-3 col-md-4">
            ...
            <a href="javascript:void(0);" class="d-block footer-link mb-4"
              ><img src="aplikasi/material/assets/img/front-pages/landing-page/apple-icon.png" alt="apple icon"
            /></a>
            <a href="javascript:void(0);" class="d-block footer-link"
              ><img src="aplikasi/material/assets/img/front-pages/landing-page/google-play-icon.png" alt="google play icon"
            /></a>
          </div>
        </div>
      </div>
