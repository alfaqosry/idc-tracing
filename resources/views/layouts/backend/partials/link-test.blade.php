 ...
 <link rel="stylesheet" href="{{ asset('aplikasi/material/assets/vendor/css/rtl/core.css') }}"
     class="template-customizer-core-css" />
 <link rel="stylesheet" href="{{ asset('aplikasi/material/assets/vendor/css/rtl/theme-default.css') }}"
     class="template-customizer-theme-css" />
 <link rel="stylesheet" href="{{ asset('aplikasi/material/assets/css/demo.css') }}" />

 <!-- Vendors CSS -->
 <link rel="stylesheet"
     href="{{ asset('aplikasi/material/assets/vendor/libs/perfect-scrollbar/perfect-scrollbar.css') }}" />
 ...
 <link rel="stylesheet"
     href="{{ asset('aplikasi/material/assets/vendor/libs/@form-validation/form-validation.css') }}" />
