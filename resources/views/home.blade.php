...
<div data-bs-spy="scroll" class="scrollspy-example">
    ...
    <section id="landingHero" class="section-py landing-hero position-relative">
      <img
        src="aplikasi/material/assets/img/front-pages/backgrounds/hero-bg-light.png"
        alt="hero background"
      ...
      <div class="container">
        <div class="hero-text-box text-center">
          ...
          <a href="#landingPricing" class="btn btn-lg btn-primary">Daftar Sekarang</a>
        </div>
        <div class="position-relative hero-animation-img">
          <a href="../vertical-menu-template/app-ecommerce-dashboard.html" target="_blank">
            <div class="hero-dashboard-img text-center">
              <img
                src="aplikasi/material/assets/img/front-pages/landing-page/hero-dashboard-light.png"
                alt="hero dashboard"
                class="animation-img"
                data-speed="2"
            ...
            <div class="position-absolute hero-elements-img">
              <img
                src="aplikasi/material/assets/img/front-pages/landing-page/hero-elements-light.png"
                alt="hero elements"
                class="animation-img"
                data-speed="4"
    ...
    <section id="landingFeatures" class="section-py landing-features">
      <div class="container">
        <h6 class="text-center d-flex justify-content-center align-items-center mb-6">
          <img
            src="aplikasi/material/assets/img/front-pages/icons/section-tilte-icon.png"
        ...
        <div class="features-icon-wrapper row gx-0 gy-12 gx-sm-6 mt-n4 mt-sm-0">
          <div class="col-lg-4 col-sm-6 text-center features-icon-box">
            <div class="features-icon mb-4">
              <img src="aplikasi/material/assets/img/front-pages/icons/laptop-charging.png" alt="laptop charging" />
            </div>
          ...
          <div class="col-lg-4 col-sm-6 text-center features-icon-box">
            <div class="features-icon mb-4">
              <img src="aplikasi/material/assets/img/front-pages/icons/transition-up.png" alt="transition up" />
            </div>
          ...
          <div class="col-lg-4 col-sm-6 text-center features-icon-box">
            <div class="features-icon mb-4">
              <img src="aplikasi/material/assets/img/front-pages/icons/edit.png" alt="edit" />
            </div>
          ...
          <div class="col-lg-4 col-sm-6 text-center features-icon-box">
            <div class="features-icon mb-4">
              <img src="aplikasi/material/assets/img/front-pages/icons/3d-select-solid.png" alt="3d select solid" />
            </div>
          ...
          <div class="col-lg-4 col-sm-6 text-center features-icon-box">
            <div class="features-icon mb-4">
              <img src="aplikasi/material/assets/img/front-pages/icons/lifebelt.png" alt="lifebelt" />
            </div>
          ...
          <div class="col-lg-4 col-sm-6 text-center features-icon-box">
            <div class="features-icon mb-4">
              <img src="aplikasi/material/assets/img/front-pages/icons/google-docs.png" alt="google docs" />
            </div>
            ...
            <div class="swiper-slide">
              <div class="card h-100">
                <div class="card-body text-body d-flex flex-column justify-content-between text-center p-8">
                  <div class="mb-4">
                    <img
                      src="aplikasi/material/assets/img/front-pages/branding/logo-4.png"
                      alt="client logo"
            ...
            <div class="swiper-slide">
              <div class="card h-100">
                <div class="card-body text-body d-flex flex-column justify-content-between text-center p-8">
                  <div class="mb-4">
                    <img
                      src="aplikasi/material/assets/img/front-pages/branding/logo-1.png"
                      alt="client logo"
                      class="client-logo img-fluid" />
                  </div>
            ...
            <div class="swiper-slide">
              <div class="card h-100">
                <div class="card-body text-body d-flex flex-column justify-content-between text-center p-8">
                  <div class="mb-4">
                    <img
                      src="aplikasi/material/assets/img/front-pages/branding/logo-3.png"
                      alt="client logo"
                      class="client-logo img-fluid" />
                  </div>
                  <h6>
            ...
            <div class="swiper-slide">
              <div class="card h-100">
                <div class="card-body text-body d-flex flex-column justify-content-between text-center p-8">
                  <div class="mb-4">
                    <img
                      src="aplikasi/material/assets/img/front-pages/branding/logo-2.png"
                      alt="client logo"
                      class="client-logo img-fluid" />
                  </div>
                  <h6>
            ...
            <div class="swiper-slide">
              <div class="card h-100">
                <div class="card-body text-body d-flex flex-column justify-content-between text-center p-8">
                  <div class="mb-4">
                    <img
                      src="aplikasi/material/assets/img/front-pages/branding/logo-5.png"
                      alt="client logo"
                      class="client-logo img-fluid" />
                  </div>
                  <h6>
        ...
        <div class="swiper-logo-carousel pt-lg-4 mt-12">
          <div class="swiper" id="swiper-clients-logos">
            <div class="swiper-wrapper">
              <div class="swiper-slide">
                <img
                  src="aplikasi/material/assets/img/front-pages/branding/logo-1-light.png"
                  alt="client logo"
                  class="client-logo"
              ...
              <div class="swiper-slide">
                <img
                  src="aplikasi/material/assets/img/front-pages/branding/logo-2-light.png"
                  alt="client logo"
                  class="client-logo"
              ...
              <div class="swiper-slide">
                <img
                  src="aplikasi/material/assets/img/front-pages/branding/logo-3-light.png"
                  alt="client logo"
                  class="client-logo"
              ...
              <div class="swiper-slide">
                <img
                  src="aplikasi/material/assets/img/front-pages/branding/logo-4-light.png"
                  alt="client logo"
                  class="client-logo"
              ...
              <div class="swiper-slide">
                <img
                  src="aplikasi/material/assets/img/front-pages/branding/logo-5-light.png"
                  alt="client logo"
                  class="client-logo"
    ...
    <section id="landingTeam" class="section-py landing-team">
      <div class="container bg-icon-right position-relative">
        <img
          src="aplikasi/material/assets/img/front-pages/icons/bg-right-icon-light.png"
          alt="section icon"
          ...
          <div class="col-lg-3 col-sm-6">
            <div class="card card-hover-border-primary mt-4 mt-lg-0 shadow-none">
              <div class="bg-label-primary position-relative team-image-box">
                <img
                  src="aplikasi/material/assets/img/front-pages/landing-page/team-member-1.png"
          ...
          <div class="col-lg-3 col-sm-6">
            <div class="card card-hover-border-danger mt-4 mt-lg-0 shadow-none">
              <div class="bg-label-danger position-relative team-image-box">
                <img
                  src="aplikasi/material/assets/img/front-pages/landing-page/team-member-2.png"
                  class="position-absolute card-img-position bottom-0 start-50 scaleX-n1-rtl"
                  alt="human image" />
              </div>
              <div class="card-body text-center">
          ...
          <div class="col-lg-3 col-sm-6">
            <div class="card card-hover-border-success mt-4 mt-lg-0 shadow-none">
              <div class="bg-label-success position-relative team-image-box">
                <img
                  src="aplikasi/material/assets/img/front-pages/landing-page/team-member-3.png"
                  class="position-absolute card-img-position bottom-0 start-50 scaleX-n1-rtl"
                  alt="human image" />
              </div>
              <div class="card-body text-center">
          ...
          <div class="col-lg-3 col-sm-6">
            <div class="card card-hover-border-info mt-4 mt-lg-0 shadow-none">
              <div class="bg-label-info position-relative team-image-box">
                <img
                  src="aplikasi/material/assets/img/front-pages/landing-page/team-member-4.png"
                  class="position-absolute card-img-position bottom-0 start-50 scaleX-n1-rtl"
                  alt="human image" />
              </div>
              <div class="card-body text-center">
    ...
    <section id="landingPricing" class="section-py bg-body landing-pricing">
      <div class="container bg-icon-left position-relative">
        <img
          src="aplikasi/material/assets/img/front-pages/icons/bg-left-icon-light.png"
          alt="section icon"
          ...
          <div class="col-xl-4 col-lg-6">
            <div class="card shadow-none border">
              <div class="card-header border-0 p-6 p-sm-8">
                ...
                <img src="aplikasi/material/assets/img/front-pages/icons/smiling-icon.png" alt="smiling icon" />
              </div>
              <div class="card-body p-6 p-sm-8 pt-0">
                <ul class="list-unstyled">
                  <li>
                    <h5 class="mb-3">
                      <img
                        src="aplikasi/material/assets/img/front-pages/icons/list-arrow-icon.png"
                        alt="list arrow icon"
        ...
        <div class="row gy-5">
          <div class="col-lg-5">
            <div class="text-center">
              <img
                src="aplikasi/material/assets/img/front-pages/landing-page/sitting-girl-with-laptop.png
        "
    ...
    <section id="landingCTA" class="section-py landing-cta p-lg-0 pb-0 position-relative">
      <img
        src="aplikasi/material/assets/img/front-pages/backgrounds/cta-bg.png"
      ...
      <div class="container">
        <div class="row align-items-center gy-5 gy-lg-0">
          ...
          <div class="col-lg-6 pt-lg-12">
            <img
              src="aplikasi/material/assets/img/front-pages/landing-page/cta-dashboard.png"
              alt="cta dashboard"
              class="img-fluid" />
          </div>
        </div>
          ...
          <div class="col-lg-5">
            <div class="card h-100">
              <div class="bg-primary rounded-4 text-white card-body p-8">
                ...
                <img
                  src="aplikasi/material/assets/img/front-pages/landing-page/let’s-contact.png
            "
                  alt="let’s contact"
                  class="w-100 mb-5" />
